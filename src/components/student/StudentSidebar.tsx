...
import { LayoutDashboard, BookOpen, Clock, FileText, LogOut } from "lucide-react";
...
const navItems = [
  ...
  { name: "Practice Tests", href: "/student/practice", icon: BookOpen },
  // { name: "Recent Results", href: "/student/results", icon: FileText },
];
...
export function StudentSidebar() {
  ...
  return (
    <aside className="w-[256px] bg-sidebar border-r border-sidebar-border flex flex-col h-full flex-shrink-0">
      <div className="p-5">
        <div className="text-[18px] font-bold text-ocean-text">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-ocean text-white font-semibold border-l-[3px] border-ocean-deep"
